...
public class Movie {
    ...
    public Movie(final Movie movie) {
        ...
        this.setRatings(new ArrayList<>());
        for (Integer rating : movie.getRatings()) {
     ...
     * @return
     */
    public boolean containsActors(final ArrayList<String> actors) {
     ...
     * @return
     */
    public boolean containsGenres(final ArrayList<String> genres) {
